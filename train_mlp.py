...
batch_size: int = 256
epochs: int = 1000
model_name = "./MLP_BinaryConnect.pth"
...
model = Binarized_MLP(mode="stochastic",
                      is_dropout=False,
                      dropout_prob=1.0,
                      optimizer=optimizer,
...
for epoch in range(epochs):
    ...
    writer.add_scalar(
        "Vanila BinaryConnect stochastic/Loss/train", train_loss, epoch)
    writer.add_scalar(
        "Vanila BinaryConnect stochastic/Loss/valid", valid_loss, epoch)
    writer.add_scalar(
        "Vanila BinaryConnect stochastic/Acc/valid", valid_acc, epoch)
